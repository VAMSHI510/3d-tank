...
public class TankView : MonoBehaviour, IDamagable
{
    ...
    //Values--------------------------
    private float mvtSpeed, rotatingSpeed, maxHealth, tankExplosionDelay = 1f;
    ...
    private void Awake()
    {
        ...
        mvtJoystick = GetComponent<Joystick>();
        shootJoystick = GetComponent<Joystick>();
    ...
    {
        while (canShoot&& Mathf.Abs(shootJoystick.Direction.x) >= 0.7 || Mathf.Abs(shootJoystick.Direction.y) >= 0.7 && gameObject.activeInHierarchy)
        {
    ...
    public void DestroyTank()
    {
        ...
        TankService.Instance.tanks.Remove(this);
        PoolService.Disable(gameObject);
